...
class DatabaseConnection:
    def __init__(self, host="localhost", user="root", password="You7hanas1", database="school"):
        self.host = host
        self.user = user
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Status bar and add status bar elements
...
class AboutDialog(QMessageBox):
    def __init__(self):
        ...
        content = """This is an app created during the Python megacourse
            to organize students, feel free to modify it"""
